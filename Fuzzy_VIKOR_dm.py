...
def fuzzyVIKOR_fuzzydm(num_val_sublv2,ave_dmqualitative_list,c_optimise_setdata_list):
    ...
    # Function: VIKOR
    def fuzzy_vikor_method(dataset, weights, criterion_type, strategy_coefficient):
    ...
    try:
        fQi=fuzzy_vikor_method(database, ave_dmqualitative_list, c_optimise_setdata_list, strategy_coefficient)
